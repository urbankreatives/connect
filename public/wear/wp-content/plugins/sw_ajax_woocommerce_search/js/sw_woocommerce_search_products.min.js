    ...
    t.utils = n, e.Autocomplete = t, t.defaults = {
        ...
        getSuggestions: function(t) {
            ...
            if (r.params[r.paramName] = t, !1 !== r.onSearchStart.call(a.element, r.params)) {
                if (o = r.ignoreParams ? null : r.params, e.isFunction(r.lookup)) return void r.lookup(t, function(e) {
                    a.suggestions = e.suggestions, a.suggest(), r.onSearchComplete.call(a.element, t, e.suggestions)
                });
                a.isLocal ? n = a.getSuggestionsLocal(t) : (e.isFunction(l) && (l = l.call(a.element, t)), s = l + "?" + e.param(o || {}), n = a.cachedResponse[s]), n && Array.isArray(n.suggestions) ? (a.suggestions = n.suggestions, a.suggest(), r.onSearchComplete.call(a.element, t, n.suggestions)) : a.isBadQuery(t) ? r.onSearchComplete.call(a.element, t, []) : (a.abortAjax(), i = {
                    url: l,
                    data: o,
                    type: r.type,
                    dataType: r.dataType
        ...
        suggest: function() {
            if (this.suggestions.length) {
                ...
                return o.triggerSelectOnValidInput && n.isExactMatch(a) ? void n.select(0) : (e.each(n.suggestions, function(e, t) {
                    s && (d += p(t, 0)), d += '<div class="' + r + '" data-index="' + e + '">' + i(t, a, e) + "</div>"
                }), this.adjustContainerWidth(), c.detach(), u.html(d), e.isFunction(g) && g.call(n.element, u, n.suggestions), n.fixPosition(), u.show(), o.autoSelectFirst && (n.selectedIndex = 0, u.scrollTop(0), u.children("." + r).first().addClass(l)), n.visible = !0, void n.findBestHint())
            }
        ...
        adjustScroll: function(t) {
            ...
            if (o) {
                ...
                s = o.offsetTop, a = (i = e(n.suggestionsContainer).scrollTop()) + n.options.maxHeight - r, s < i ? e(n.suggestionsContainer).scrollTop(s) : s > a && e(n.suggestionsContainer).scrollTop(s - n.options.maxHeight + r), n.options.preserveInput || n.el.val(n.getValue(n.suggestions[t].value)), n.signalHint(null)
            }
        },
        onSelect: function(t) {
            var n = this,
...
function(e) {
    e(".topsearch-entry").each(function() {
        var t = e(this).find(".search"),
            n = t.data("show_image"),
            o = t.data("show_price"),
            s = t.data("character"),
            i = t.data("search_type"),
            a = t.data("height_image"),
            r = t.data("width_image"),
            l = t.data("limit"),
            u = e(this).find(".search-append"),
            c = e(this).find(".category-selection"),
            g = sw_livesearch.ajaxurl + "?action=sw_search_products_callback&limit=" + l + "&search_type=" + i;
        if (c.length && "" !== c.val() && (g += "&product_cat=" + c.val()), e(this).find(".autosearch-input").devbridgeAutocomplete({
                minChars: s,
                appendTo: u,
                ...
                onSearchStart: function() {
                    e(".button-search-pro").removeClass("loading"), e(".button-search-pro").addClass("loading")
                },
                onSelect: function(e) {
                    -1 != e.id && (window.location.href = e.link)
                },
                onSearchComplete: function() {
                    e(".button-search-pro").removeClass("loading")
                },
                beforeRender: function(t) {
                    e(t).removeAttr("style")
                },
                formatResult: function(t, s) {
                    var i = "(" + e.Autocomplete.utils.escapeRegExChars(s) + ")",
                        l = "";
                    return -1 != t.id ? (l += '<a class="media-left" href="' + t.link + '">', n && (l += '<img width="' + r + '" height="' + a + '" class="pull-left" src="' + t.img + '">'), l += '<div class="media-body">', l += "<span>" + t.value.replace(new RegExp(i, "gi"), "<strong>$1</strong>") + "</span>", l += '<div class="search-meta">', "" != t.sku && (l += '<div class="sku"><span>' + sw_livesearch.sku + ": </span>" + t.sku.replace(new RegExp(i, "gi"), "<strong>$1</strong>") + "</div>"), o && (l += t.price), l += "</div>", l += "</div>", l += "</a>") : l += '<div class="no-result">' + t.value.replace(new RegExp(i, "gi"), "<strong>$1</strong>") + "</div>", l
                }
            }), c.length) {
            var d = e(this).find(".autosearch-input").devbridgeAutocomplete();
            c.on("change", function(e) {
                "" != c.val() ? d.setOptions({
                    serviceUrl: sw_livesearch.ajaxurl + "?action=sw_search_products_callback&limit=" + l + "&search_type=" + i + "&product_cat=" + c.val()
                }) : d.setOptions({
                    serviceUrl: sw_livesearch.ajaxurl + "?action=sw_search_products_callback&limit=" + l + "&search_type=" + i
                }), d.hide(), d.onValueChange()
            })
        }
    })
}(jQuery);