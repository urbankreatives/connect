! function() {
    ...
    function n(i) {
        ...
        var a, s, r, d, c, l, u, f, h, p = function() {
                ! function(e, t) {
                    if (e !== t) throw new TypeError("Cannot instantiate an arrow function")
                }(this, undefined);
                var e = {},
        ...
        var w = function() {
            ...
            return {
                ...
                setSettings: function(e) {
                    c = !!((d = e).userAuthConfig && d.userAuthConfig.jwtAuthEnabled && d.userAuthConfig.strictModeEnabled), l = !(!d.userAuthConfig || !d.userAuthConfig.jwtAuthEnabled)
                },
                ...
                init: function(e) {
                    n = e.token, i = e.widgetUuid, a = e.referrer, r = e.host, s = e.siteId, c = !1, l = !1, u = e.jwtAuthToken, f = !1, h = e.flowId, p = e.flowVersionId, w = e.isTemplateBot, g = e.previewMode, b = e.cspNonce, y = e.omniCookie, _ = e.eagerLoad, k = e.jsFunctions || {}
                },
                reset: function() {
                ...
                add: function() {
                    var t = document,
                        ...
                        s = o.getConfig(),
                        r = s && s.cssNames;
                    i && "DIV" === i.tagName || (i = t.createElement("DIV"), n.appendChild(i)), v.setAttr(i, {
                        id: e.frameDivId,
                        class: r && r.widget || ""
                    }), i.classList.add("fc_dn"), s && s.headerProperty ? ("ltr" === s.headerProperty.direction && i.classList.add("fc_l2r"), s.headerProperty.hideChatButton || i.classList.remove("fc_dn")) : i.classList.remove("fc_dn"), v.setAttr(a, {
                        id: e.frameId,
                        name: e.frameId,
                        title: "Chat",
                        frameborder: "0",
                ...
                setFramePosition: function() {
                    var t, n, i, o, a = this.getSettings(),
                        ...
                        l = s ? null == a || null === (i = a.appearanceConfig) || void 0 === i ? void 0 : i.widgetRightOffsetPx : "15";
                    if (s && "TEXT" === (null == a || null === (o = a.appearanceConfig) || void 0 === o ? void 0 : o.widgetLauncherStyle)) {
                        var u, f = document.createElement("span");
                        f.innerText = null == a || null === (u = a.appearanceConfig) || void 0 === u ? void 0 : u.widgetLauncherValue, f.id = "fc-chat-temp-text", f.style.cssText = '\n          font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", "Roboto", "Oxygen", "Ubuntu", "Fira Sans", "Droid Sans", "Helvetica Neue", Arial, sans-serif;\n          font-size: 14px;\n          font-weight:500;\n          white-space: nowrap;\n          visibility: hidden;\n          position: absolute;\n          bottom: 0px;\n        ', r.parentNode.appendChild(f);
                        var h = document.createElement("style");
                        h.innerHTML = "#fc_frame.fc-launcher-text{width: ".concat(f.offsetWidth + 60, "px}"), r.parentNode.appendChild(h), r.parentNode.removeChild(f), r.classList.add("fc-launcher-text")
                    }
                    r.style.bottom = "".concat(c || 15, "px"), d ? (r.classList.add("fc-widget-left"), r.style.left = "".concat(l || 15, "px")) : r.style.right = "".concat(l || 15, "px")
                },
        ...
        var x = function() {
            ...
            return {
                ...
                add: function() {
                    ...
                    o && "DIV" === o.tagName || (o = n.createElement("DIV"), i.appendChild(o)), o.setAttribute("id", e.pushFrameDivId), v.setAttr(a, {
                        id: e.pushFrameId,
                        src: t,
                        title: "Chat",
                        frameborder: "0"
        ...
        var I = function() {
            ...
            return {
                ...
                destroy: function() {
                    ...
                    o && (v.purge(o), i.removeChild(o)), window.removeEventListener ? window.removeEventListener("keydown", t.bind(this)) : window.detachEvent("keydown", t.bind(this))
                }
            }
        }.bind(void 0)();
        var L = function() {
        ...
        var B = function() {
                ...
                var t = null,
                    ...
                    s = function(t) {
                        S(this, e), v.unbindEvent("keypress", a), v.unbindEvent("mousemove", a), v.unbindEvent("click", a), t && (v.bindEvent("keypress", a), v.bindEvent("mousemove", a), v.bindEvent("click", a))
                    }.bind(this),
                    r = function() {
                        S(this, e);
                    ...
                    u = function() {
                        S(this, e), "hidden" === document.visibilityState && l()
                    }.bind(this);
                return {
                    start: function() {
                        c(), v.bindEvent("focus", c), v.bindEvent("blur", l), v.bindEvent("beforeunload", l), v.bindEvent("visibilitychange", u)
                    },
                    stop: function() {
                        l(), v.unbindEvent("focus", c), v.unbindEvent("blur", l), v.unbindEvent("beforeunload", l), v.unbindEvent("visibilitychange", u)
                    }
                }
            }.bind(void 0)(),
            P = function() {
        ...
        var D = {
            ...
            process: function(e) {
                ...
                e.handler ? y.subscribe(e.action, e.payload, function(n) {
                    M(this, t), "function" == typeof e.handler && e.handler(n), this.run()
        ...
        var R = {
                ...
                unloadWidget: function() {
                    x.isLoaded() && x.unload(), t.reset(), o.reset(), O(), w.reset(), w.remove(e.frameDivId), this.unsubscribe(), E.publish("widget:destroyed", null, !0), E.clear()
                },
                ...
                onMessage: function(n) {
                    ...
                    if (a === w.getHost() || a === x.getHostOrigin()) {
                        ...
                        if (this.updateFrameSettings(d.settingsPayload), c) {
                            var l, u, f = document.getElementById(e.frameDivId),
                                h = r && r.expanded || "expanded",
                                p = w.checkIfMultiWidget(),
                                g = w.getSettings(),
                                m = null == g || null === (l = g.appearanceConfig) || void 0 === l ? void 0 : l.widgetRightOffsetPx,
                                b = "BOTTOM_LEFT" === (null == g || null === (u = g.appearanceConfig) || void 0 === u ? void 0 : u.widgetPosition);
                            switch (c) {
                                case "push_subscribe_destroy_response":
                                    this.unloadWidget();
                                    break;
                                case "TRIGGER_JS_FUNCTION":
                                    var C, _ = null === (C = d.data.functionName) || void 0 === C ? void 0 : C.replace("options.", ""),
                                        k = w.getJsFunctions()[_],
                                        L = k && k.call(this, JSON.parse(d.data.params));
                                    d.data.value = L, w.postMessage(d);
                                    break;
                                case "OPEN_URL":
                                ...
                                case "restore_user_cookie":
                                    N.removeCookie(), N.setCookie(d.alias), w.postMessage({
                                ...
                                case "notify_frame":
                                    var T = d.data,
                                        ...
                                        B = r && r.open || "fc-open";
                                    "expand" === T ? (S.style.removeProperty("max-height"), S.style.removeProperty("height"), S.classList.add("h-open-notify"), S.classList.add(B), S.classList.add(T)) : "close" === T ? (S.style.removeProperty("max-height"), S.style.removeProperty("height"), S.classList.remove("h-open-notify"), S.classList.remove(B), S.classList.remove("expand")) : "mobile-view" === T ? S.classList.add("fc-mobile-view") : (S.classList.add("h-open-notify"), S.classList.add(B));
                                    break;
                                case "resize_frame":
                                    var O = document.getElementsByTagName("BODY")[0],
                                        M = r && r.open || "fc-open";
                                    t.opened(d.isOpen), t.isOpened() ? (f.classList.add("h-open-container"), f.classList.add(M), f.classList.add("widget-open-animate"), E.publish("widget:opened"), setTimeout(function() {
                                        F(this, i), f.classList.remove("widget-open-animate")
                                    }.bind(this), 1e3), O && O.classList.add("fc-widget-open")) : (f.style.removeProperty("max-height"), f.style.removeProperty("height"), f.classList.remove("h-open-container"), f.classList.remove(M), E.publish("widget:closed"), O && O.classList.remove("fc-widget-open"));
                                    break;
                                case "toggle_frame":
                                    d.show ? f.classList.remove("hide") : -1 === f.className.trim().indexOf("hide") && f.classList.add("hide");
                                    break;
                                case "push_frame_loaded":
                                    x.loaded(!0), x.setSource(n && n.source), x.postMessage({
                                        action: "widget_location",
                                        openWindow: !1,
                                        payload: window.location.href
                                    }), w.postMessage({
                                ...
                                case "frame_state_change":
                                    var A = document.getElementById(e.frameDivId),
                                        ...
                                        V = o.getConfig();
                                    E.publish("frame:statechange", d), "initialized" === U && (w.isJWTEnabled() && w.isJWTStrictMode() && A.classList.add("fc_dn"), null != V && V.eagerLoad && A.classList.add("hide"), this.loadWidget(), j && -1 !== j.indexOf("COBROWSING") && W.init({
                                        host: w.getHost(),
                                        locale: o.getProperties().locale
                                    })), "loaded" === U && w.loaded(!0), "authenticated" !== U && "not_authenticated" !== U || w.isJWTEnabled() && w.isJWTStrictMode() && (d.success ? A.classList.remove("fc_dn") : 304 !== d.status && this.unloadWidget());
                                    break;
                                case "widget_loaded":
                                    t.loaded(!0), E.publish("widget:loaded");
                                    var q = o.getConfig(),
                                        J = document.getElementById(e.frameDivId);
                                    null != q && q.eagerLoad && J.classList.remove("hide"), x.isLoaded() || x.init({
                                ...
                                case "enlarge_image":
                                    ...
                                    break;
                                case "expand_all":
                                    document.getElementById(e.frameDivId).classList.add("expanded-modal"), document.getElementById(e.frameDivId).classList.add(h);
                                    break;
                                case "expand_article_view":
                                    p && window.innerWidth < e.FAQ_EXPAND_WIDTH + m && (f.classList.add(b ? "expand-article-left" : "expand-article-right"), f.style.setProperty(b ? "left" : "right", "15px")), f.classList.remove("collapsed-article_view", "collapse-article-left", "collapse-article-right"), f.classList.add("expanded-article_view");
                                    break;
                                case "collapse_article_view":
                                    p && (f.classList.add(b ? "collapse-article-left" : "collapse-article-right"), f.style.setProperty(b ? "left" : "right", "".concat(m, "px"))), f.classList.remove("expanded-article_view"), f.classList.add("collapsed-article_view");
                                    break;
                                case "collapse_all_article_view":
                                    f.classList.remove("expanded-article_view", "collapsed-article_view"), p && (f.style.setProperty(b ? "left" : "right", "".concat(m, "px")), f.classList.remove("expand-article-left", "expand-article-right", "collapse-article-left", "collapse-article-right"));
                                    break;
                                case "set_bubble_height":
                                    document.getElementById(e.frameDivId).style.height = d.height + "px";
                                    break;
                                case "collapse_all":
                                    document.getElementById(e.frameDivId).classList.remove("expanded-modal"), document.getElementById(e.frameDivId).classList.remove(h), document.getElementById(e.frameDivId).classList.add("avoid-jitter"), setTimeout(function() {
                                        F(this, i), document.getElementById(e.frameDivId).classList.remove("avoid-jitter")
                                    }.bind(this), 300);
                                    break;
                                ...
                                case "user_created":
                                    var z = d.data;
                                    if (t.isLoaded()) z && o.setRestoreId(z.restoreId), this.onUserCreate(d);
                                    else if (d.success) {
                                        var H = z && z.externalId,
                                            G = z && z.restoreId,
                                            X = o.getExternalId();
                                        X ? X === H && (o.setRestoreId(G), this.onUserCreate(d)) : this.onUserCreate(d)
                                    } else this.onUserCreate(d);
                                    break;
                                case "user_cleared":
                                    E.publish("user:cleared"), x.postMessage({
                                ...
                                case "stack_max_height":
                                    ...
                                    document.getElementById(e.frameDivId).style.maxHeight = oe + "px", w.postMessage({
                        ...
                        return function(t) {
                            ...
                            var d = e.impostor.tagName,
                                ...
                                l = function(e) {
                                    ...
                                    function l() {
                                        var e, t;
                                        $(this, l), ne(G(t = a.call(this)), "onDemandCB", void 0), t.attachShadow({
                                            mode: "open"
                            ...
                            return document.body.appendChild(u), u
        ...
        var fe = function() {
            ...
            return {
                ...
                authenticate: function(e) {
                    ...
                    if (w.isJWTEnabled()) {
                        var n = function() {
                                ue(this, t), w.setJWTAuthToken(e), w.postMessage({
