            ...
            return function(g, i, j, k) {
                ...
                (function() {
                    ...
                    var a = f.getFbeventsModules("SignalsFBEventsQE"),
                        ...
                        j = i.coerce,
                        k = i.Typed;
                    i = f.getFbeventsModules("SignalsFBEventsOpenBridgeConfigTypedef");
                    var m = f.getFbeventsModules("SignalsFBEventsParallelFireConfigTypedef"),
        ...
        f.ensureModuleRegistered("signalsFBEventsSendEvent", function() {
            return function(g, h, i, j) {
                ...
                (function() {
                    ...
                    var j = f.getFbeventsModules("signalsFBEventsSendBatch"),
                        ...
                        o = f.getFbeventsModules("signalsFBEventsSendXHRWithRetry"),
                    ...
                    var u = a.BATCHING_EXPERIMENT,
                        v = a.DISALLOW_PII_ON_STRICT_NON_SUBMIT,
                        w = a.NETWORK_RETRY_EXPERIMENT,
                        x = a.SEND_BEACON_STRING_EXPERIMENT,
                        y = a.SEND_XHR_EXPERIMENT,
                        z = g.top !== g,
                    ...
                    function B(a) {
                        ...
                        typeof b !== "undefined" && b !== null && (typeof b.rex !== "undefined" && b.rex !== null ? b.rex.ex === "t" ? a.appendHash({
                            exp: "b1"
                        }) : b.rex.ex === "c" && a.appendHash({
                            exp: "b0"
                        }) : b.aex2 === "t" ? a.appendHash({
                            exp: "d1"
                        }) : b.aex2 === "c" && a.appendHash({
                            exp: "d0"
                        }));
                        a.append("cd", b);
                        ...
                        if (a.get("exp") == null) {
                            m = d.get();
                            m != null && m.name !== w && m.name !== v && a.append("exp", m.code)
                        }
                        return a
                    }

                    function C(a) {
                        var e = typeof XMLHttpRequest !== "undefined" && "withCredentials" in new XMLHttpRequest(),
                            f = r.trigger(a);
                        if (s(f, function(a) {
                                return a
                            })) return;
                        ...
                        g = Object.prototype.hasOwnProperty.call(a, "customData") && typeof a.customData !== "undefined" && a.customData !== null;
                        g || (a.customData = {});
                        if (d.isInTest(w)) {
                            a.customData.rex = {
                                ex: "t",
                            ...
                            if (e) {
                                i = B(a);
                                o(i, a.customData, t.ENDPOINT);
                                b.trigger("POST", i, a.customData);
                                return
                            }
                        } else d.isInControl(w) && (a.customData.rex = {
                            ex: "c",
                            sx: e,
                            retry: 0,
                            failed: []
        ...
        f.ensureModuleRegistered("signalsFBEventsSendXHRWithRetry", function() {
            return function(g, h, i, j) {
                ...
                (function() {
                    ...
                    function g(a, f, h) {
                        if (f.rex.retry > d) {
                            b(new Error("Reached the max number of retries"));
                            return
                        }
                        ...
                        i.onreadystatechange = function() {
                            i.readyState === e.DONE && (i.status !== 200 && setTimeout(function() {
                                f.rex.retry++, f.rex.failed.push(i.status), g(a, f, h)
                            }, c))
                        };
                        a.replaceObjectEntry("cd", f);
                        i.send(a.toFormData())
                    }
                    k.exports = g
                })();
            ...
            return function(a, b, c, d) {
                ...
                (function() {
                    ...
                    var H = A.fired,
                        ...
                        M = t.global,
                        N = -1,
                        ga = "b68919aff001d8366249403a2544fba2d833084f1ad22839b6310aadacb6a138",
                    ...
                    function ma(a) {
                        ...
                        switch (a) {
                            ...
                            case "firstPartyCookies":
                                ...
                                typeof p === "string" ? U.callMethod([r, p, "FirstPartyCookies"]) : p === void 0 ? U.disableFirstPartyCookies = !0 : L({
                                    invalidParamName: "pixel_id",
                                    invalidParamValue: p,
                                    method: "set",
                                    params: e,
                            ...
                            case "parallelfire":
                                var A = c[0],
                                    B = c[1];
                                U.pluginConfig.set(A, "parallelfire", {
                                    target: B
                                });
                                break;
                            case "trackSingleOnly":
                                ...
                                G.error && L(G.error);
                                G.warnings && G.warnings.forEach(function(a) {
                                    L(a)
                                });
                                O.call(S, F) ? S[F].trackSingleOnly = E : L({
                                    metadataValue: a,
                                    pixelID: F,
                                ...
                                break;
                            default:
                                var H = U.pluginConfig.getWithGlobalFallback(null, "dataProcessingOptions"),
                    ...
                    function X(a, b, c) {
                        ...
                        if (O.call(S, d)) {
                            b != null && D(S[d].userData) ? (S[d].userData = e ? b || {} : {}, V.loadPlugin("identity")) : L({
                                pixelID: d,
                    ...
                    function pa(a, b, c) {
                        b = b || {}, q.validateEventAndLog(a, b), a === "CustomEvent" && typeof b.event === "string" && (a = b.event), Y.call(this, a, b, c)
                    }
                    ...
                    function sa(a, b, c, d) {
                        ...
                        try {
                            var g = a && a.userData || {},
                                ...
                                k = {},
                                l = void 0;
                            g.em != null && Z(g.em) && (l = Z(g.em), l === 1 && (i.em = ga));
                            h.em != null && Z(h.em) && (l = Z(h.em), l === 1 && (k.em = ga));
                        ...
                        e.append("coo", g);
                        i = U.pluginConfig.getWithGlobalFallback(a ? a.id : null, "dataProcessingOptions");
                        if (i != null) {
                    ...
                    function xa() {
                        return {
                            pixelInitializationTime: N,
                            pixels: R
                        }
                    }

                    function ya(a) {
                        a.instance = U, a.callMethod = W, a._initHandlers = [], a._initsDone = {}, a.send = ra, a.getEventCustomParameters = sa, a.addInitHandler = wa, a.getState = xa, a.init = X, a.set = ma, a.loadPlugin = function(a) {
...
fbq.registerPlugin("global_config", {
    ...
    plugin: function(fbq, instance, config) {
        ...
        fbq.set("experiments", [{
            ...
            "allocation": 0.02,
            "code": "d",
            "name": "disallow_pii_on_strict_non_submit",
            "passRate": 0.5
        }]);
