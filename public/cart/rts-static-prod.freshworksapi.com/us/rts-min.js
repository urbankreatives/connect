    ...
    return t.prototype = {
        ...
        initializeSocket: function() {
            ...
            this.checkCookieSupport(function(t) {
                var e;
                o.nocookie = t, 1 != o.clientClose && (n = o._getQueryParams(t), t = o.generateWsUrl(o.origin, n), null != window.WebSocket ? (o.log("creating new socket,", Date()), e = new WebSocket(t), o.websocket = e, o.websocket.onopen = function() {
                    ...
                    o.websocket == e && (window.clearTimeout(o.stableConnectionTimer), o.errorHandler(t))
                }) : o.initializeSocketIO())
            })
        },
        initializeWebSocket: function(e) {
            ...
            }), this.ping_worker = new Worker(URL.createObjectURL(t)), this.ping_worker.onmessage = function(t) {
                "trigger_callback" == t.data.type ? n.websocket == e ? 1 == e.readyState && e.send("9") : n.ping_worker.postMessage({
                    type: "stop_interval",
                    intervalReference: o
                }) : "initiated" == t.data.type && (o = t.data.intervalReference)
        ...
        initializeSocketListeners: function() {
            this.log("Binding the socket listeners..."), this.socket.on("connect", function() {
                this.onFallback(), this._onConnect()
            }.bind(this)), this.socket.on("connect_error", this._onConnectError.bind(this)), this.socket.on("reconnecting", this._onReconnecting.bind(this)), this.socket.on("reconnect", this._onReconnect.bind(this)), this.socket.on("disconnect", this._onDisconnect.bind(this)), this.socket.on("message", this._onMessage.bind(this))
        },
        ...
        _onConnect: function() {
            var t;
            this.reconnectionFlag || (t = (new Date).getTime() - this.connection_startTime, this.log("Socket Connected"), this.websocket ? (this.log("Time Taken by Websocket:- ", t), this.websocket.id = this._generateUid()) : this.log("Time Taken by Socket.IO:- ", t), this.connected = !0, this.firstConnectionSuccess = !0, this._fireCallback(this.onConnect, this.reconnectionFlag), this.reconnectionFlag = !0)
        },
        ...
        _onReconnect: function() {
            ...
            }), this._fireCallback(n.onReconnect)
        },
        ...
        _onEvent: function(t) {
            ...
            "APP_PUBLISH" != t.event || "function" != typeof this.onAppMessage ? ("send" == t.event || "CHANNEL_JOIN" == t.event || "LEFT_CHANNEL" === t.event) && t.channel && this.channels[t.channel] && "function" == typeof this.channels[t.channel].onMessage ? this._fireCallback(this.channels[t.channel].onMessage, t) : this._fireCallback(this.onMessage, t) : this._fireCallback(this.onAppMessage, t)
        },
        ...
        io: function o(i, r, s) {
            ...
            3: [function(t, e, n) {
                ...
                }(e.exports = l).prototype.emitAll = function() {
                ...
                }, l.prototype.open = l.prototype.connect = function(n) {
            ...
            5: [function(t, e, n) {
                ...
                o(l.prototype), l.prototype.subEvents = function() {
                    ...
                    if (u.hasOwnProperty(t)) return p.apply(this, arguments), this;
                    var e = s(arguments),
                        n = r.EVENT,
                        n = {
                    ...
                    var e = t.data || [];
                    a("emitting event %j", e), null != t.id && (a("attaching ack callback to event"), e.push(this.ack(t.id))), this.connected ? p.apply(this, e) : this.receiveBuffer.push(e)
                }, l.prototype.ack = function(n) {
                    var o = this,
                        i = !1;
                    return function() {
                        var t, e;
                    ...
                    for (var t = 0; t < this.receiveBuffer.length; t++) p.apply(this, this.receiveBuffer[t]);
            ...
            13: [function(e, h, t) {
                ! function(n) {
                    var o = e("./transports"),
                        ...
                        p = e("debug")("engine.io-client:socket"),
                        i = e("indexof"),
                    ...
                    function l(t, e) {
                    ...
                    }(h.exports = l).priorWebsocketSuccess = !1, t(l.prototype), l.protocol = r.protocol, (l.Socket = l).Transport = e("./transport"), l.transports = e("./transports"), l.parser = e("engine.io-parser"), l.prototype.createTransport = function(t) {
                        ...
                        var e = this;
                        this.transport && (p("clearing existing transport %s", this.transport.name), this.transport.removeAllListeners()), (this.transport = t).on("drain", function() {
                            e.onDrain()
                        ...
                        function t() {
                            var t;
                            i.onlyBinaryUpgrades && (t = !this.supportsBinary && i.transport.supportsBinary, e = e || t), e || (p('probe transport "%s" opened', n), o.send([{
                                type: "ping",
                                data: "probe"
                            }]), o.once("packet", function(t) {
                                e || ("pong" == t.type && "probe" == t.data ? (p('probe transport "%s" pong', n), i.upgrading = !0, i.emit("upgrading", o), o && (l.priorWebsocketSuccess = "websocket" == o.name, p('pausing current transport "%s"', i.transport.name), i.transport.pause(function() {
                                    e || "closed" != i.readyState && (p("changing transport and sending upgrade packet"), u(), i.setTransport(o), o.send([{
                                        type: "upgrade"
                                    }]), i.emit("upgrade", o), o = null, i.upgrading = !1, i.flush())
                                }))) : (p('probe transport "%s" failed', n), (t = new Error("probe error")).transport = o.name, i.emit("upgradeError", t)))
                            }))
                        }
                        ...
                        function s(t) {
                            ...
                            e.transport = o.name, r(), p('probe transport "%s" failed because of error: %s', n, t), i.emit("upgradeError", e)
                        }
                        ...
                        function h(t) {
                            o && t.name != o.name && (p('"%s" works - aborting "%s"', t.name, o.name), r())
                        }
                        ...
                        l.priorWebsocketSuccess = !1, o.once("open", t), o.once("error", s), o.once("close", c), this.once("close", a), this.once("upgrading", h), o.open()
                    }, l.prototype.onOpen = function() {
                        if (p("socket open"), this.readyState = "open", l.priorWebsocketSuccess = "websocket" == this.transport.name, this.emit("open"), this.flush(), "open" == this.readyState && this.upgrade && this.transport.pause) {
                            p("starting upgrade probes");
                            for (var t = 0, e = this.upgrades.length; t < e; t++) this.probe(this.upgrades[t])
                        }
                    }, l.prototype.onPacket = function(t) {
                        if ("opening" == this.readyState || "open" == this.readyState) switch (p('socket receive: type "%s", data "%s"', t.type, t.data), this.emit("packet", t), this.emit("heartbeat"), t.type) {
                            case "open":
                        ...
                        clearTimeout(t.pingIntervalTimer), t.pingIntervalTimer = setTimeout(function() {
                            p("writing ping packet - expecting pong within %sms", t.pingTimeout), t.ping(), t.onHeartbeat(t.pingTimeout)
                        }, t.pingInterval)
                    ...
                    }, l.prototype.write = l.prototype.send = function(t, e) {
                        return this.sendPacket("message", t, e), this
                    }, l.prototype.sendPacket = function(t, e, n) {
                        ...
                        function t() {
                            o.onClose("forced close"), p("socket closing - telling transport to close"), o.transport.close()
                        }
                        ...
                        p("socket error %j", t), l.priorWebsocketSuccess = !1, this.emit("error", t), this.onClose("transport error", t)
                    }, l.prototype.onClose = function(t, e) {
                        var n;
                        "opening" != this.readyState && "open" != this.readyState && "closing" != this.readyState || (p('socket close with reason: "%s"', t), n = this, clearTimeout(this.pingIntervalTimer), clearTimeout(this.pingTimeoutTimer), setTimeout(function() {
            ...
            17: [function(u, p, t) {
                ! function(o) {
                    ...
                    p.exports = c, p.exports.Request = a, e(c, r), c.prototype.supportsBinary = !0, c.prototype.request = function(t) {
            ...
            25: [function(y, t, g) {
                ! function(h) {
                    var t = y("./keys"),
                        e = y("has-binary"),
                        f = y("arraybuffer.slice"),
                        o = y("base64-arraybuffer"),
                        s = y("after"),
                        r = y("utf8"),
                    ...
                    g.encodePacket = function(t, e, n, o) {
                        ...
                        return {
                            type: n,
                            data: t = "blob" === e && p ? new p([t]) : t
                        }
                    }, g.encodePayload = function(t, n, o) {
                        "function" == typeof n && (o = n, n = null);
                        var i = e(t);
                        return n && i ? p && !c ? g.encodePayloadAsBlob(t, o) : g.encodePayloadAsArrayBuffer(t, o) : t.length ? void l(t, function(t, e) {
                            g.encodePacket(t, !!i && n, !0, function(t) {
                                e(null, t.length + ":" + t)
                            })
                        }, function(t, e) {
                            return o(e.join(""))
                        ...
                        for (var o, i = "", r = 0, s = t.length; r < s; r++) {
                            ...
                            if (":" != c) i += c;
                                ...
                                if (c.length) {
                                    if (c = g.decodePacket(c, e, !0), d.type == c.type && d.data == c.data) return n(d, 0, 1);
                    ...
                    }, g.encodePayloadAsArrayBuffer = function(t, o) {
                        ...
                        l(t, function(t, s) {
                            g.encodePacket(t, !0, !0, function(t) {
                                ...
                                r[i.length] = 255, p && (e = new p([e.buffer, r.buffer, t]), s(null, e))
                            })
                        }, function(t, e) {
                            return n(new p(e))
                        })
                    }, g.decodePayloadAsBinary = function(t, n, o) {
                        "function" == typeof n && (o = n, n = null);
                        for (var e = t, i = [], r = !1; 0 < e.byteLength;) {
                            ...
                            if (c) try {
                                ...
                                for (var p = new Uint8Array(u), u = "", h = 0; h < p.length; h++) u += String.fromCharCode(p[h])
                            }
                            i.push(u), e = f(e, a)
                        }
                        var l = i.length;
                        i.forEach(function(t, e) {
                            o(g.decodePacket(t, n, !0), e, l)
                        })
                    }
                }.call(this, "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
            }, {
                ...
                ! function(y) {
                    ! function(t) {
                        var e = "object" == typeof m && m,
                            n = "object" == typeof g && g && g.exports == e && g,
                            o = "object" == typeof y && y;
                        ...
                        var l = {
                            ...
                            decode: function(t) {
                                ...
                                for (var e, n = []; !1 !== (e = function() {
                                        ...
                                        if (192 == (224 & t)) {
                                            if (128 <= (e = (31 & t) << 6 | p())) return e;
                                            throw Error("Invalid continuation byte")
                                        }
                                        if (224 == (240 & t)) {
                                            if (2048 <= (e = (15 & t) << 12 | p() << 6 | p())) return h(e), e;
                                            throw Error("Invalid continuation byte")
                                        }
                                        if (240 == (248 & t) && 65536 <= (e = (15 & t) << 18 | p() << 12 | p() << 6 | p()) && e <= 1114111) return e;
            ...
            44: [function(t, e, s) {
                ...
                s.protocol = 4, s.types = ["CONNECT", "DISCONNECT", "EVENT", "BINARY_EVENT", "ACK", "BINARY_ACK", "ERROR"], s.CONNECT = 0, s.DISCONNECT = 1, s.EVENT = 2, s.ACK = 3, s.ERROR = 4, s.BINARY_EVENT = 5, s.BINARY_ACK = 6, s.Encoder = r, s.Decoder = u, r.prototype.encode = function(t, e) {
                    ...
                    if ("string" == typeof t) e = function(t) {
                        var e = {},
                            n = 0;
                        if (e.type = Number(t.charAt(0)), null == s.types[e.type]) return l();
                    ...
                    }(t), s.BINARY_EVENT == e.type || s.BINARY_ACK == e.type ? (this.reconstructor = new p(e), 0 === this.reconstructor.reconPack.attachments && this.emit("decoded", e)) : this.emit("decoded", e);
                    else {
            ...
            47: [function(t, e, O) {
                ! function(t) {
                    ...
                    var u, _, S, I, a, A, n, T, p, h, o, B, l, E, R, f, d, y, g, m, i, r, s, b, N, v = new Date(-0xc782b5b800cec);
                    try {
                    ...
                    function k(t) {
                        ...
                        else if ("json" == t) e = k("json-stringify") && k("json-parse");
                        else {
                            var n = '{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}';
                            if ("json-stringify" == t) {
                                var o = c.stringify,
                                    i = "function" == typeof o && v;
                                if (i) {
                                    (r = function() {
                                        return 1
                                    }).toJSON = r;
                                    try {
                                        i = "0" === o(0) && "0" === o(new Number) && '""' == o(new String) && o(x) === C && o(C) === C && o() === C && "1" === o(r) && "[1]" == o([r]) && "[null]" == o([C]) && "null" == o(null) && "[null,null,null]" == o([C, x, null]) && o({
                                            a: [r, !0, !1, null, "\0\b\n\f\r\t"]
                    ...
                    k("json") || (u = "[object Function]", _ = "[object Number]", S = "[object String]", I = "[object Array]", a = k("bug-string-char-index"), v || (A = Math.floor, n = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334], T = function(t, e) {
                        ...
                        return h = null, (N = i ? 2 == i ? function(t, e) {
                            var n, o = {},
                                i = x.call(t) == u;
                            ...
                            var n, o, i, r, s, c = x.call(t) == u,
                                a = c || "function" == typeof t.constructor || ("object" == (s = typeof(i = t)[r = "hasOwnProperty"]) ? !i[r] : p[s]) ? w : t.hasOwnProperty;
                        ...
                        var c, a, h, u, p, l, f, d, y, g, m, b, v, k;
                        try {
                            c = e[t]
                        } catch (t) {}
                        if ("object" == typeof c && c)
                            if ("[object Date]" != (a = x.call(c)) || w.call(c, "toJSON")) "function" == typeof c.toJSON && (a != _ && a != S && a != I || w.call(c, "toJSON")) && (c = c.toJSON(t));
                            else if (-1 / 0 < c && c < 1 / 0) {
                            if (T) {
                                for (p = A(c / 864e5), h = A(p / 365.2425) + 1970 - 1; T(h + 1, 0) <= p; h++);
                                for (u = A((p - T(h, 0)) / 30.42); T(h, u + 1) <= p; u++);
                                p = 1 + p - T(h, u), l = A((y = (c % 864e5 + 864e5) % 864e5) / 36e5) % 24, f = A(y / 6e4) % 60, d = A(y / 1e3) % 60, y = y % 1e3
                            } else h = c.getUTCFullYear(), u = c.getUTCMonth(), p = c.getUTCDate(), l = c.getUTCHours(), f = c.getUTCMinutes(), d = c.getUTCSeconds(), y = c.getUTCMilliseconds();
                            c = (h <= 0 || 1e4 <= h ? (h < 0 ? "-" : "+") + B(6, h < 0 ? -h : h) : B(4, h)) + "-" + B(2, u + 1) + "-" + B(2, p) + "T" + B(2, l) + ":" + B(2, f) + ":" + B(2, d) + "." + B(3, y) + "Z"
                        } else c = null;
                        if (null === (c = n ? n.call(e, t, c) : c)) return "null";
                        if ("[object Boolean]" == (a = x.call(c))) return "" + c;
                        if (a == _) return -1 / 0 < c && c < 1 / 0 ? "" + c : "null";
                        if (a == S) return E("" + c);
                        if ("object" == typeof c) {
                            for (v = s.length; v--;)
                                if (s[v] === c) throw TypeError();
                            if (s.push(c), g = [], t = r, r += i, a == I) {
                                for (b = 0, v = c.length; b < v; b++) m = R(b, c, n, o, i, r, s), g.push(m === C ? "null" : m);
                                k = g.length ? i ? "[\n" + r + g.join(",\n" + r) + "\n" + t + "]" : "[" + g.join(",") + "]" : "[]"
                            } else N(o || c, function(t) {
                                var e = R(t, c, n, o, i, r, s);
                                e !== C && g.push(E(t) + ":" + (i ? " " : "") + e)
                            }), k = g.length ? i ? "{\n" + r + g.join(",\n" + r) + "\n" + t + "}" : "{" + g.join(",") + "}" : "{}";
                            return s.pop(), k
                        }
                        ...
                        if ("function" == typeof e || "object" == typeof e && e)
                            ...
                            for (var s, c = {}, a = 0, h = e.length; a < h; s = e[a++], (r = x.call(s)) != S && r != _ || (c[s] = 1));
                        if (n)
                            if ((r = x.call(n)) == _) {
                                if (0 < (n -= n % 1))
                                    for (o = "", 10 < n && (n = 10); o.length < n; o += " ");
                            } else r == S && (o = n.length <= 10 ? n : n.slice(0, 10));
                        return R("", ((s = {})[""] = t, s), i, c, o, "", [])
                    }), k("json-parse") || (f = String.fromCharCode, d = {
                        92: "\\",
                        34: '"',
                        47: "/",
                        98: "\b",
                        ...
                        throw y = g = null, SyntaxError()
                    }, i = function() {
                        for (var t, e, n, o, i, r = g, s = r.length; y < s;) switch (i = r.charCodeAt(y)) {
                            case 9:
                            case 10:
                            case 13:
                            case 32:
                            ...
                            case 58:
                            case 44:
                                return t = a ? r.charAt(y) : r[y], y++, t;
                            case 34:
                                for (t = "@", y++; y < s;)
                                    if ((i = r.charCodeAt(y)) < 32) m();
                                    else if (92 == i) switch (i = r.charCodeAt(++y)) {
                                    case 92:
                                    case 34:
                                    case 47:
                                    case 98:
                                    ...
                                    case 114:
                                        ...
                                        break;
                                    case 117:
                                        for (e = ++y, n = y + 4; y < n; y++) 48 <= (i = r.charCodeAt(y)) && i <= 57 || 97 <= i && i <= 102 || 65 <= i && i <= 70 || m();
                                        t += f("0x" + r.slice(e, y));
                                        break;
                                    default:
                                        m()
                                    ...
                                    if (34 == i) break;
                                    for (i = r.charCodeAt(y), e = y; 32 <= i && 92 != i && 34 != i;) i = r.charCodeAt(++y);
                                    t += r.slice(e, y)
                                }
                                if (34 == r.charCodeAt(y)) return y++, t;
                                m();
                            default:
                                if (e = y, 45 == i && (o = !0, i = r.charCodeAt(++y)), 48 <= i && i <= 57) {
                                    for (48 == i && (48 <= (i = r.charCodeAt(y + 1)) && i <= 57) && m(), o = !1; y < s && (48 <= (i = r.charCodeAt(y)) && i <= 57); y++);
                                    if (46 == r.charCodeAt(y)) {
                                        for (n = ++y; n < s && (48 <= (i = r.charCodeAt(n)) && i <= 57); n++);
                                        n == y && m(), y = n
                                    }
                                    if (101 == (i = r.charCodeAt(y)) || 69 == i) {
                                        for (43 != (i = r.charCodeAt(++y)) && 45 != i || y++, n = y; n < s && (48 <= (i = r.charCodeAt(n)) && i <= 57); n++);
                                        n == y && m(), y = n
                                    }
                                    return +r.slice(e, y)
                                }
                                if (o && m(), "true" == r.slice(y, y + 4)) return y += 4, !0;
                                if ("false" == r.slice(y, y + 5)) return y += 5, !1;
                                if ("null" == r.slice(y, y + 4)) return y += 4, null;
                                m()
                        }
                        return "$"
                    }, r = function(t) {
                        ...
                        var n;
                        return y = 0, g = "" + t, n = r(i()), "$" != i() && m(), y = g = null, e && x.call(e) == u ? b(((t = {})[""] = n, t), "", e) : n
                    }))
                }(this)
            }, {}],
            48: [function(t, e, n) {
