...
! function(n) {
    ...
    var e, n, p, s, r, h, f, g, m, y, v, i, o, w, a, a = (t && t.fn && t.fn.select2 && t.fn.select2.amd && (u = t.fn.select2.amd), u && u.requirejs || (u ? n = u : u = {}, g = {}, m = {}, y = {}, v = {}, i = Object.prototype.hasOwnProperty, o = [].slice, w = /\.js$/, h = function(e, t) {
            var n, i, o = c(e),
                s = o[0],
                t = t[1];
            return e = o[1], s && (n = x(s = l(s, t))), s ? e = n && n.normalize ? n.normalize(e, (i = t, function(e) {
                return l(e, i)
            })) : l(e, t) : (s = (o = c(e = l(e, t)))[0], e = o[1], s && (n = x(s))), {
                f: s ? s + "!" + e : e,
                n: e,
                pr: s,
                p: n
            ...
            if ("undefined" == u || "function" == u) {
                for (t = !t.length && n.length ? ["require", "exports", "module"] : t, a = 0; a < t.length; a += 1)
                    ...
                    r.p.load(r.n, b(i, !0), function(t) {
                        return function(e) {
                            g[t] = e
                        }
                    }(s), {}), c[a] = g[s]
                }
                u = n ? n.apply(g[e], c) : undefined, e && (o && o.exports !== p && o.exports !== g[e] ? g[e] = o.exports : u === p && l || (g[e] = u))
            } else e && (g[e] = n)
            ...
            return t = t || function() {}, "function" == typeof n && (n = i, i = o), i ? s(p, e, t, n) : setTimeout(function() {
                s(p, e, t, n)
            }, 4), r
        }, r.config = function(e) {
            return r(e)
            ...
            return e.Extend(i, e.Observable), i.prototype.render = function() {
                var e = d('<ul class="select2-results__options" role="listbox" tabindex="-1"></ul>');
                ...
                this.data.current(function(e) {
                    ...
                    t.$results.find(".select2-results__option[data-selected]").each(function() {
                        var e = d(this),
                            t = d.data(this, "data"),
                            n = "" + t.id;
                        null != t.element && t.element.selected || null == t.element && -1 < d.inArray(n, i) ? e.attr("data-selected", "true") : e.attr("data-selected", "false")
                    })
                })
                ...
                for (n in e.disabled && (delete i["data-selected"], i["aria-disabled"] = "true"), null == e.id && delete i["data-selected"], null != e._resultId && (t.id = e._resultId), e.title && (t.title = e.title), e.children && (i["aria-label"] = e.text, delete i["data-selected"]), i) {
                    var o = i[n];
                    t.setAttribute(n, o)
                }
                if (e.children) {
                ...
                this.$results.attr("id", n), t.on("results:all", function(e) {
                    ...
                    var e = o.$results.parents(".select2-container").find("input.select2-search__field")[0];
                    void 0 !== e && e.focus()
                }), t.on("close", function() {
                    ...
                    0 !== t.length && (e = t.data("data"), "true" == t.attr("data-selected") ? o.trigger("close", {}) : o.trigger("select", {
                        data: e
                    }))
                    ...
                    e.element.addClass("select2-results__option--highlighted").attr("aria-selected", "true"), o.$results.attr("aria-activedescendant", e.element.attr("id"))
                    ...
                    var t = d(this),
                        n = t.data("data");
                    "true" !== t.attr("data-selected") ? o.trigger("select", {
                        originalEvent: e,
                        data: n
                ...
                0 !== o.length && (e = this.$results.find("[data-selected]").index(o), i = this.$results.offset().top, t = o.offset().top, n = this.$results.scrollTop() + (t - i), i = t - i, n -= 2 * o.outerHeight(!1), e <= 2 ? this.$results.scrollTop(0) : (i > this.$results.outerHeight() || i < 0) && this.$results.scrollTop(n))
        ...
        }), u.define("select2/selection/base", ["jquery", "../utils", "../keys"], function(i, e, o) {
            function n(e, t) {
        ...
        }), u.define("select2/selection/single", ["jquery", "./base", "../utils", "../keys"], function(e, t, i, n) {
            function s() {
            ...
            return i.Extend(s, t), s.prototype.render = function() {
                ...
                var o = this.options.get("label");
                "string" == typeof o ? this.$selection.attr("aria-label", o) : this.$selection.attr("aria-labelledby", i), this.$selection.attr("role", "combobox"), this.$selection.on("mousedown", function(e) {
                ...
                var t, n;
                0 !== e.length ? (t = e[0], n = this.$selection.find(".select2-selection__rendered"), e = i.entityDecode(this.display(t, n)), n.empty().text(e), n.prop("title", t.title || t.text)) : this.clear()
            }, s
        }), u.define("select2/selection/multiple", ["jquery", "./base", "../utils"], function(i, e, l) {
            function o(e, t) {
                ...
                if (this.clear(), 0 !== e.length) {
                    for (var t = [], n = 0; n < e.length; n++) {
                        var i = e[n],
                            ...
                            s = o.html(),
                            r = this.display(i, o);
                        "string" == typeof r && (r = l.entityDecode(r.trim())), o.text(r), o.prepend(s), o.prop("title", i.title || i.text), o.data("data", i), t.push(o)
                    }
            ...
            return e.prototype.normalizePlaceholder = function(e, t) {
                ...
                return n.text(i.entityDecode(this.display(t))), n.addClass("select2-selection__placeholder").removeClass("select2-selection__choice"), n
        ...
        }), u.define("select2/selection/search", ["jquery", "../utils", "../keys"], function(n, e, r) {
            function t(e, t, n) {
                e.call(this, t, n)
            }
            return t.prototype.render = function(e) {
                var t = n('<li class="select2-search select2-search--inline"><input class="select2-search__field" type="text" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false" role="textbox" aria-autocomplete="list" /></li>');
                ...
                var i = this,
                    o = n.id + "-results";
                e.call(this, n, t), n.on("open", function() {
                    ...
                    var t;
                    e.stopPropagation(), i.trigger("keypress", e), i._keyUpPrevented = e.isDefaultPrevented(), e.which === r.BACKSPACE && "" === i.$search.val() ? 0 < (t = i.$searchContainer.prev(".select2-selection__choice")).length && (t = t.data("data"), i.searchRemoveChoice(t), e.preventDefault()) : e.which === r.ENTER && (n.open(), e.preventDefault())
                });
            ...
            return t.Extend(n, e), n.prototype.current = function(e) {
                ...
                return null != (e = r.extend({}, {
                    text: ""
                }, e)).id && (e.id = e.id.toString()), null != e.text && (e.text = e.text.toString()), null == e._resultId && e.id && (e._resultId = this.generateResultId(this.container, e)), r.extend({}, {
                    selected: !1,
                    disabled: !1
                }, e)
            ...
            return t.Extend(n, e), n.prototype._applyDefaults = function(e) {
                ...
                function e() {
                    var e = o.transport(o, function(e) {
                        ...
                        i.options.get("debug") && window.console && console.error && (e && e.results && Array.isArray(e.results) || console.error("Select2: The AJAX results did not return an array in the `results` key of the response.")), n(e), i.container.focusOnActiveElement()
                    }, function() {
            ...
            function e(e, t, n) {
                ...
                o = n.get("insertTag");
                if (o !== undefined && (this.insertTag = o), e.call(this, t, n), Array.isArray(i))
        ...
        }), u.define("select2/dropdown/search", ["jquery", "../utils"], function(s, e) {
            function t() {}
            return t.prototype.render = function(e) {
                var t = e.call(this),
                    e = s('<span class="select2-search select2-search--dropdown"><input class="select2-search__field" type="text" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false" role="combobox" aria-autocomplete="list" aria-expanded="true" /></span>');
                ...
                e.call(this, t, n), this.$search.on("keydown", function(e) {
                    ...
                    i.$search.attr("tabindex", 0), i.$search.attr("aria-owns", o), i.$search.trigger("focus"), window.setTimeout(function() {
                        i.$search.trigger("focus")
                    }, 0)
                }), t.on("close", function() {
        ...
        }), u.define("select2/core", ["jquery", "./options", "./utils", "./keys"], function(o, s, n, r) {
            var a = function(e, t) {
                null != e.data("select2") && e.data("select2").destroy(), this.$element = e, this.id = this._generateId(e), t = t || {}, this.options = new s(t, e), a.__super__.constructor.call(this);
            ...
            return n.Extend(a, n.Observable), a.prototype._generateId = function(e) {
                ...
                e = e[0];
                Array.isArray(e) && (e = o.map(e, function(e) {
                    return e.toString()
            ...
            return {
                syncCssClasses: function(e, t, n) {
                    var i, o = [],
                        s = e.attr("class") || 0 == e.attr("class") ? e.attr("class").toString().trim() : "";
                    s && r((s = "" + s).split(/\s+/)).each(function() {
                        0 === this.indexOf("select2-") && o.push(this)
                    }), (s = t.attr("class") || 0 == t.attr("class") ? t.attr("class").toString().trim() : "") && r((s = "" + s).split(/\s+/)).each(function() {
                        0 !== this.indexOf("select2-") && null != (i = n(this)) && o.push(i)
                    }), e.attr("class", o.join(" "))
                }
            }
        }), u.define("select2/compat/containerCss", ["jquery", "./utils"], function(e, s) {
            function r(e) {
                return null
            }
            ...
            return t.prototype.render = function(e) {
                ...
                "function" == typeof n && (n = n(this.$element));
                var i, o = this.options.get("adaptContainerCssClass");
                o = o || r, -1 !== n.indexOf(":all:") && (n = n.replace(":all:", ""), i = o, o = function(e) {
                    var t = i(e);
                    return null != t ? t + " " + e : e
                });
                e = this.options.get("containerCss") || {};
                return "function" == typeof e && (e = e(this.$element)), s.syncCssClasses(t, this.$element, o), t.css(e), t.addClass(n), t
            }, t
        }), u.define("select2/compat/dropdownCss", ["jquery", "./utils"], function(e, s) {
            function r(e) {
                return null
            }
            ...
            return t.prototype.current = function(e, t) {
                var n = this;
        ...
        a = function(u) {
            ...
            var r;
            return null == o.fn.selectWoo && (r = ["open", "close", "destroy"], o.fn.selectWoo = function(t) {
            ...
            }), null != o.fn.select2 && null != o.fn.select2.defaults && (o.fn.selectWoo.defaults = o.fn.select2.defaults), null == o.fn.selectWoo.defaults && (o.fn.selectWoo.defaults = t), o.fn.select2 = o.fn.select2 || o.fn.selectWoo, s
        }), {
            define: u.define,
            require: u.require
        });
    ...
    function l(e, t) {
        var n, i, o, s, r, a, l, c, u, d, p = t && t.split("/"),
            ...
            f = h && h["*"] || {};
        if (e) {
            for (t = (e = e.split("/")).length - 1, y.nodeIdCompat && w.test(e[t]) && (e[t] = e[t].replace(w, "")), "." === e[0].charAt(0) && p && (e = p.slice(0, p.length - 1).concat(e)), c = 0; c < e.length; c++) "." === (d = e[c]) ? (e.splice(c, 1), --c) : ".." === d && (0 === c || 1 === c && ".." === e[2] || ".." === e[c - 1] || 0 < c && (e.splice(c - 1, 2), c -= 2));
            e = e.join("/")
        }
        if ((p || f) && h) {
    ...
    function x(e) {
        var t;
        if (_(m, e) && (t = m[e], delete m[e], v[e] = !0, s.apply(p, t)), !_(g, e) && !_(v, e)) throw new Error("No " + e);
        return g[e]
    }
