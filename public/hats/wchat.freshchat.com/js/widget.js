! function() {
    ...
    function n(i) {
        ...
        var o = function() {
            ...
            return {
                ...
                setUserMeta: function(e) {
                    if (l.meta = l.meta || {}, e)
                        for (var t in e) e.hasOwnProperty(t) && (l.meta[t] = e[t])
                },
        ...
        var a, s, r, d, c, u, l, f, h, p = function() {
                ! function(e, t) {
                    if (e !== t) throw new TypeError("Cannot instantiate an arrow function")
                }(this, undefined);
                var e = {},
                ...
                return {
                    setProperties: function(i) {
                        for (var o in i) "fc_override_bot_property" !== o && (t[o] = i[o]);
                        for (var a in n = i.fc_override_bot_property) e[a] = n[a];
                        for (var s in e)
                            for (var r in t) e[s].hasOwnProperty(r) || (e[s][r] = t[r]);
            ...
            m = {
                ...
                getAgent: (c = navigator.appVersion, u = navigator.userAgent, l = navigator.appName, f = "" + parseFloat(c), h = parseInt(c, 10), -1 !== u.indexOf("Station") && (d = "Station"), -1 !== (s = u.indexOf("Opera")) ? (l = "Opera", f = u.substring(s + 6), -1 !== (s = u.indexOf("Version")) && (f = u.substring(s + 8))) : -1 !== (s = u.indexOf("MSIE")) ? (l = "Microsoft Internet Explorer", f = u.substring(s + 5)) : -1 !== (s = u.indexOf("Edge")) ? (l = "Edge", f = u.substring(s + 5)) : -1 !== (s = u.indexOf("Trident")) ? (l = "Trident", f = u.substring(s + 8)) : -1 !== (s = u.indexOf("Chrome")) ? (l = "Chrome", f = u.substring(s + 7)) : -1 !== (s = u.indexOf("Safari")) ? (l = "Safari", f = u.substring(s + 7), -1 !== (s = u.indexOf("Version")) && (f = u.substring(s + 8))) : -1 !== (s = u.indexOf("Firefox")) ? (l = "Firefox", f = u.substring(s + 8)) : -1 === (s = u.indexOf("Mobile")) || -1 === u.indexOf("iPad") && -1 === u.indexOf("iPhone") && -1 === u.indexOf("iPod") && -1 === u.indexOf("wv") ? (a = u.lastIndexOf(" ") + 1) < (s = u.lastIndexOf("/")) && (l = u.substring(a, s), f = u.substring(s + 1), l.toLowerCase() === l.toUpperCase() && (l = navigator.appName)) : (l = "WebView", f = u.substring(s + 8)), -1 !== (r = f.indexOf(";")) && (f = f.substring(0, r)), -1 !== (r = f.indexOf(" ")) && (f = f.substring(0, r)), h = parseInt("" + f, 10), isNaN(h) && (f = "" + parseFloat(c), h = parseInt(c, 10)), {
                    name: l,
                    appName: d,
                    version: h,
                    versionx: f,
        ...
        var w = function() {
            ...
            return {
                ...
                setSettings: function(e) {
                    c = !!((d = e).userAuthConfig && d.userAuthConfig.jwtAuthEnabled && d.userAuthConfig.strictModeEnabled), u = !(!d.userAuthConfig || !d.userAuthConfig.jwtAuthEnabled)
                },
                ...
                init: function(e) {
                    n = e.token, i = e.widgetUuid, a = e.referrer, r = e.host, s = e.siteId, c = !1, u = !1, l = e.jwtAuthToken, f = !1, h = e.flowId, p = e.flowVersionId, w = e.isTemplateBot, g = e.previewMode, b = e.cspNonce, y = e.omniCookie, _ = e.eagerLoad, k = e.jsFunctions || {}
                },
                reset: function() {
                    n = i = a = r = s = c = u = l = f = h = p = g = y = w = void 0
                },
                getJSON: function() {
                    return {
                        token: n,
                ...
                load: function(e, n, i) {
                    if (m.isSafariBrowser() && b) {
                        var o = document.createElement("script");
                        o.nonce = b, o.textContent = 'window.location = "'.concat(e, '"'), t = i.contentWindow, i.contentDocument.body.appendChild(o)
                ...
                add: function() {
                    var t = document,
                        ...
                        s = o.getConfig(),
                        r = s && s.cssNames;
                    i && "DIV" === i.tagName || (i = t.createElement("DIV"), n.appendChild(i)), m.setAttr(i, {
                        id: e.frameDivId,
                        class: r && r.widget || ""
                    }), i.style.setProperty("--launcher-width", "unset"), i.classList.add("fc_dn"), s && s.headerProperty ? ("ltr" === s.headerProperty.direction && i.classList.add("fc_l2r"), s.headerProperty.hideChatButton || i.classList.remove("fc_dn")) : i.classList.remove("fc_dn"), m.setAttr(a, {
                        id: e.frameId,
                        name: e.frameId,
                        title: "Chat",
                        frameborder: "0",
                ...
                loadRTSCanaryWidget: function(t) {
                    ...
                    a = r + a, o.open("GET", a, !0), o.onreadystatechange = function() {
                        if (v(this, i), 4 === o.readyState) {
                            var n = m.parseJSON(o.response),
                ...
                loadCanaryWidget: function() {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
                        ...
                        s = "";
                    s = !g || "botflow" !== g && "autofaq" !== g ? "".concat(r, "/widget/").concat(t, "?token=").concat(n, "&referrer=").concat(a) : "".concat(r, "/widget/").concat(t, "?token=").concat(n, "&referrer=").concat(a, "&previewMode=").concat(g), i && (s += "&widgetUuid=".concat(i)), _ && (s += "&eagerLoad=true"), this.load(s, e.frameId, o)
                },
                remove: function(e) {
                    m.remove(e), t = null
                },
                setFrameSize: function() {
                    var t, n = this.getSettings(),
                        i = o.getConfig(),
                        a = n.betaFeatures[e.unifiedWidgetBetaFeature];
                    if (null === n) return "";
                    ...
                    !0 === r && c.classList.add(e.classes.fullscreenClass), s && s.length > 0 && (d = "fc-widget-" + s.toLowerCase()), c.classList.add(d)
                },
                setFramePosition: function() {
                    var t, n, i, o, a = this.getSettings(),
                        s = a.betaFeatures[e.unifiedWidgetBetaFeature],
                        r = document.getElementById(e.frameDivId),
                        d = s && "BOTTOM_LEFT" === (null == a || null === (t = a.appearanceConfig) || void 0 === t ? void 0 : t.widgetPosition),
                        c = s ? null == a || null === (n = a.appearanceConfig) || void 0 === n ? void 0 : n.widgetBottomOffsetPx : "15",
                        u = s ? null == a || null === (i = a.appearanceConfig) || void 0 === i ? void 0 : i.widgetRightOffsetPx : "15";
                    if (s && "TEXT" === (null == a || null === (o = a.appearanceConfig) || void 0 === o ? void 0 : o.widgetLauncherStyle)) {
                        var l, f = document.createElement("span");
                        f.innerText = null == a || null === (l = a.appearanceConfig) || void 0 === l ? void 0 : l.widgetLauncherValue, f.id = "fc-chat-temp-text", f.style.cssText = '\n          font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", "Roboto", "Oxygen", "Ubuntu", "Fira Sans", "Droid Sans", "Helvetica Neue", Arial, sans-serif;\n          font-size: 14px;\n          font-weight:500;\n          white-space: nowrap;\n          visibility: hidden;\n          position: absolute;\n          bottom: 0px;\n        ', r.parentNode.appendChild(f), r.style.setProperty("--launcher-width", "".concat(f.offsetWidth + 60, "px")), f.remove(), r.classList.add("fc-launcher-text")
                    } else r.style.setProperty("--launcher-width", "70px");
                    r.style.bottom = "".concat(c || 15, "px"), d ? (r.classList.add("fc-widget-left"), r.style.left = "".concat(u || 15, "px")) : r.style.right = "".concat(u || 15, "px")
                },
                setWidgetDisplayStyle: function() {
                    var t = document.body,
                        n = document.getElementById(e.frameDivId),
                        i = m.getElementStyle(t, "display");
                    i && -1 !== ["flex"].indexOf(i) && m.setAttr(n, {
        ...
        var y = function() {
                ...
                return {
                    subscribe: function(n, i, o) {
                        t.isLoaded() || w.isLoaded() && -1 !== w.loadingActions().indexOf("get_user_uuid") ? (e[n + "_ack"] = o, w.postMessage({
                            action: n,
                            payload: i
                        })) : b.enque({
                            action: n,
            ...
            _ = function(e, t, n) {
                t && "function" == typeof t && (n = t, t = null), y.subscribe(e, t, n)
            },
            k = function(e) {
        ...
        var I = function() {
            ...
            return {
                ...
                add: function() {
                    ...
                    o && "DIV" === o.tagName || (o = n.createElement("DIV"), i.appendChild(o)), o.setAttribute("id", e.pushFrameDivId), m.setAttr(a, {
                        id: e.pushFrameId,
                        src: t,
                        title: "Chat",
                        frameborder: "0"
                ...
                load: function() {
                    m.isPushSupportedByBrowser() && this.add()
                },
                unload: function() {
                    m.remove(e.pushFrameDivId), this.reset()
                }
            }
        }.bind(void 0)();
        var x = function() {
            ...
            return {
                ...
                destroy: function() {
                    ...
                    o && (m.purge(o), i.removeChild(o)), window.removeEventListener ? window.removeEventListener("keydown", t.bind(this)) : window.detachEvent("keydown", t.bind(this))
                }
            }
        }.bind(void 0)();
        var L = function() {
        ...
        var T = function() {
            ...
            var e, t, n, i = function(i) {
                    e = i.oldValue, t = i.newValue, n = i.title, w.postMessage({
            ...
            return {
                start: function() {
                    ...
                    }), L.attach(window.history, "pushState", o), L.attach(window.history, "replaceState", o), window.addEventListener ? (window.addEventListener("hashchange", o, !1), window.addEventListener("popstate", o, !1)) : (window.attachEvent("hashchange", o, !1), window.attachEvent("popstate", o, !1))
                },
                stop: function() {
                    e = t = void 0, L.detach(window.history, "pushState"), L.detach(window.history, "replaceState"), window.removeEventListener ? (window.removeEventListener("hashchange", o), window.removeEventListener("popstate", o)) : (window.detachEvent("hashchange", o), window.detachEvent("popstate", o))
                },
                track: i
            }
        }.bind(void 0)();
        ...
        var S = function() {
                ...
                var t = null,
                    ...
                    a = function() {
                        B(this, e), n = (new Date).getTime()
                    }.bind(this),
                    s = function(t) {
                        B(this, e), m.unbindEvent("keypress", a), m.unbindEvent("mousemove", a), m.unbindEvent("click", a), t && (m.bindEvent("keypress", a), m.bindEvent("mousemove", a), m.bindEvent("click", a))
                    }.bind(this),
                    r = function() {
                        B(this, e);
                    ...
                    d = function() {
                        B(this, e), i && clearInterval(i), i = null, n = null, t = null
                    }.bind(this),
                    c = function() {
                        B(this, e), d(), s(!0), t = (new Date).getTime(), i = setInterval(r, 6e4)
                    }.bind(this),
                    u = function() {
                        B(this, e), n = (new Date).getTime(), o(), d(), s(!1)
                    }.bind(this),
                    l = function() {
                        B(this, e), "hidden" === document.visibilityState && u()
                    }.bind(this);
                return {
                    start: function() {
                        c(), m.bindEvent("focus", c), m.bindEvent("blur", u), m.bindEvent("beforeunload", u), m.bindEvent("visibilitychange", l)
                    },
                    stop: function() {
                        u(), m.unbindEvent("focus", c), m.unbindEvent("blur", u), m.unbindEvent("beforeunload", u), m.unbindEvent("visibilitychange", l)
                    }
                }
            }.bind(void 0)(),
            P = function() {
        ...
        var M = {
            ...
            process: function(e) {
                ...
                e.handler ? y.subscribe(e.action, e.payload, function(n) {
                    D(this, t), "function" == typeof e.handler && e.handler(n), this.run()
                }.bind(this)) : (y.subscribe(e.action, e.payload), setTimeout(function() {
                    D(this, t), this.run()
                }.bind(this), 0))
            }
        };
                ...
                return function(e, t) {
                    ...
                    init: function(e) {
                        var t = document.createElement("script"),
                            n = e.host;
                        t.type = "text/javascript", t.src = n + "/widget/js/co-browsing.js", (document.body ? document.body : document.getElementsByTagName("head")[0]).appendChild(t), window.fc_cobrowse = {
                            host: e.host,
                            locale: e.locale
                        }
                    }
        ...
        var R = {
                ...
                loadWidget: function() {
                    if (!1 === t.isInitialized()) {
                        ...
                        var e = w.getJSON(),
                            ...
                            s = t.getFaqTags(),
                            r = p.getProperties();
                        if (e.integrations = o.getIntegrations(), e.campaignRuleIds = o.getcampaignRuleIds(), e.externalId = o.getExternalId(), e.restoreId = o.getRestoreId(), e.flowId = o.getFlowId(), e.flowVersionId = o.getFlowVersionId(), e.previewMode = o.getPreviewMode(), e.isTemplateBot = o.getIsTemplateBot(), e.identifyByReferenceId = o.getIdentifyByReferenceId(), n && (e.properties = n), r && (e.botsMeta = r), i && (e.config = i), a && (e.tags = a), s && (e.faqTags = s), e.userAgent = m.getAgent, m.storageAvailable) {
                            var d = e.token,
                                c = localStorage.getItem(d),
                                u = e.siteId ? "".concat(e.token, "_").concat(e.siteId) : null,
                                l = u ? localStorage.getItem(u) : null;
                            if ((c || u && l) && (e.storage = {}, e.storage[d] = c || JSON.stringify({}), u && (e.storage[u] = l || JSON.stringify({}))), i && i.overrideDS) {
                                var f = "lsds_".concat(u || d),
                                    h = localStorage.getItem(f);
                                h ? e.lsds = A({}, f, h) : (e.lsds = A({}, f, JSON.stringify({})), e.migrateLFDS = !0)
                            }
                        }
                        w.setFrameSize(), w.setFramePosition(), w.setWidgetDisplayStyle(), w.postMessage({
                            action: "load_widget",
                            payload: e
                        })
                    }
                ...
                unloadWidget: function() {
                    I.isLoaded() && I.unload(), t.reset(), o.reset(), O(), w.reset(), w.remove(e.frameDivId), this.unsubscribe(), E.publish("widget:destroyed", null, !0), E.clear()
                },
                ...
                onMessage: function(n) {
                    var i = this,
                        ...
                        s = o.getConfig(),
                        r = s && s.cssNames;
                    if (a === w.getHost() || a === I.getHostOrigin()) {
                        var d = n.data,
                            c = d && d.action;
                        if (this.updateFrameSettings(d.settingsPayload), c) {
                            var u = document.getElementById(e.frameDivId),
                                l = r && r.expanded || "expanded";
                            switch (c) {
                                case "push_subscribe_destroy_response":
                                    this.unloadWidget();
                                    break;
                                case "TRIGGER_JS_FUNCTION":
                                    var f, h = null === (f = d.data.functionName) || void 0 === f ? void 0 : f.replace("options.", ""),
                                        p = w.getJsFunctions()[h],
                                        g = p && p.call(this, JSON.parse(d.data.params));
                                    d.data.value = g, w.postMessage(d);
                                    break;
                                case "OPEN_URL":
                                ...
                                case "reset_user_cookie":
                                    W.removeCookie(), w.postMessage({
                                        action: "update_cookie",
                                        payload: {
                                            omniCookie: W.getCookie()
                                        }
                                    });
                                    break;
                                case "restore_user_cookie":
                                    W.removeCookie(), W.setCookie(d.alias), w.postMessage({
                                ...
                                case "notify_frame":
                                    var v = d.data,
                                        b = document.getElementById(e.frameDivId),
                                        C = r && r.open || "fc-open";
                                    "expand" === v ? (b.style.removeProperty("max-height"), b.style.removeProperty("height"), b.classList.add("h-open-notify"), b.classList.add(C), b.classList.add(v)) : "close" === v ? (b.style.removeProperty("max-height"), b.style.removeProperty("height"), b.classList.remove("h-open-notify"), b.classList.remove(C), b.classList.remove("expand")) : "mobile-view" === v ? b.classList.add("fc-mobile-view") : (b.classList.add("h-open-notify"), b.classList.add(C));
                                    break;
                                case "resize_frame":
                                    var _ = document.getElementsByTagName("BODY")[0],
                                        k = r && r.open || "fc-open";
                                    t.opened(d.isOpen), t.isOpened() ? (u.classList.add("h-open-container"), u.classList.add(k), u.classList.add("widget-open-animate"), E.publish("widget:opened"), setTimeout(function() {
                                        N(this, i), u.classList.remove("widget-open-animate")
                                    }.bind(this), 1e3), _ && _.classList.add("fc-widget-open")) : (u.style.removeProperty("max-height"), u.style.removeProperty("height"), u.classList.remove("h-open-container"), u.classList.remove(k), E.publish("widget:closed"), _ && _.classList.remove("fc-widget-open"));
                                    break;
                                case "toggle_frame":
                                    d.show ? u.classList.remove("hide") : -1 === u.className.trim().indexOf("hide") && u.classList.add("hide");
                                    break;
                                case "push_frame_loaded":
                                    I.loaded(!0), I.setSource(n && n.source), I.postMessage({
                                        action: "widget_location",
                                        openWindow: !1,
                                        payload: window.location.href
                                    }), w.postMessage({
                                ...
                                case "frame_state_change":
                                    var L = document.getElementById(e.frameDivId),
                                        T = d && d.data,
                                        B = T && T.frameState,
                                        S = w.getSettings() && w.getSettings().enabledFeatures,
                                        O = o.getConfig();
                                    E.publish("frame:statechange", d), "initialized" === B && (w.isJWTEnabled() && w.isJWTStrictMode() && L.classList.add("fc_dn"), null != O && O.eagerLoad && L.classList.add("hide"), this.loadWidget(), S && -1 !== S.indexOf("COBROWSING") && F.init({
                                        host: w.getHost(),
                                        locale: o.getProperties().locale
                                    })), "loaded" === B && w.loaded(!0), "authenticated" !== B && "not_authenticated" !== B || w.isJWTEnabled() && w.isJWTStrictMode() && (d.success ? L.classList.remove("fc_dn") : 304 !== d.status && this.unloadWidget());
                                    break;
                                case "widget_loaded":
                                    t.loaded(!0), E.publish("widget:loaded");
                                    var D = o.getConfig(),
                                        A = document.getElementById(e.frameDivId);
                                    null != D && D.eagerLoad && A.classList.remove("hide"), I.isLoaded() || I.init({
                                        host: d.pushDomain + "?ref=" + btoa(window.location.origin),
                                        hostOrigin: m.url_domain(d.pushDomain),
                                ...
                                case "enlarge_image":
                                    ...
                                    break;
                                case "expand_all":
                                    document.getElementById(e.frameDivId).classList.add("expanded-modal"), document.getElementById(e.frameDivId).classList.add(l);
                                    break;
                                ...
                                case "set_bubble_height":
                                    ...
                                    break;
                                case "collapse_all":
                                    document.getElementById(e.frameDivId).classList.remove("expanded-modal"), document.getElementById(e.frameDivId).classList.remove(l), document.getElementById(e.frameDivId).classList.add("avoid-jitter"), setTimeout(function() {
                                        N(this, i), document.getElementById(e.frameDivId).classList.remove("avoid-jitter")
                                    }.bind(this), 300);
                                    break;
                                ...
                                case "user_created":
                                    var R = d.data;
                                    if (t.isLoaded()) R && o.setRestoreId(R.restoreId), this.onUserCreate(d);
                                    else if (d.success) {
                                        var U = R && R.externalId,
                                            j = R && R.restoreId,
                                            V = o.getExternalId();
                                        V ? V === U && (o.setRestoreId(j), this.onUserCreate(d)) : this.onUserCreate(d)
                                    } else this.onUserCreate(d);
                                    break;
                                case "user_cleared":
                                    E.publish("user:cleared"), I.postMessage({
                                ...
                                case "remove_storage_item":
                                    if (m.storageAvailable) {
                                        var J = d.data;
                                        J && J.key && localStorage.removeItem(J.key)
                                    }
                                    break;
                                ...
                                case "set_lsds_item":
                                    if (m.storageAvailable) {
                                        ...
                                        if (H) {
                                            var G = z && z.value;
                                            localStorage.setItem(H, m.stringifyJSON(G))
                                        }
                                    }
                                    break;
                                case "get_lsds_item":
                                ...
                                case "stack_max_height":
                                    var Z = screen.height <= 568 ? screen.height : screen.height - 250;
                                    document.getElementById(e.frameDivId).style.maxHeight = Z + "px", w.postMessage({
        ...
        var q = function() {
                function e(t) {
                    ...
                    }(this, e), V(this, "listenToConfigDataCB", void 0), V(this, "payload", void 0), V(this, "resolve", void 0), V(this, "iframeWindow", void 0), this.payload = t
                }
                var t, n, i;
                return t = e, n = [{
                    key: "fetch",
        ...
        function X(e) {
            ...
            return X = function(e) {
                ...
                function i() {
                    return K(e, arguments, Z(this).constructor)
                }
        ...
        function K(e, t, n) {
            return K = Q() ? Reflect.construct : function(e, t, n) {
                var i = [null];
                i.push.apply(i, t);
        ...
        var ie = function() {
                function t(e) {
                    $(this, t), ne(this, "impostorConfig", void 0), this.impostorConfig = e
                }
                return te(t, [{
                    key: "create",
                    value: function() {
                        ...
                        return function(t) {
                            ...
                            var d = e.impostor.tagName,
                                ...
                                u = function(e) {
                                    ...
                                    function u() {
                                        var e, t;
                                        $(this, u), ne(G(t = a.call(this)), "onDemandCB", void 0), t.attachShadow({
                                            mode: "open"
                                        }).appendChild(c.content.cloneNode(!0)), t.onDemandCB = t.onDemand.bind(G(t)), null === (e = t.shadowRoot) || void 0 === e || e.querySelector("#static-bubble").addEventListener("mousedown", t.onDemandCB);
                                        var n, o, d = [];
        ...
        var ce = function() {
                function t(e) {
                    ...
                    ! function(e, t) {
                        if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                    }(this, t), de(this, "payload", void 0), de(this, "eagerLoad", void 0), de(this, "onWidgetLoadedCB", void 0), de(this, "onWidgetOpenedCB", void 0), de(this, "listenToConfigDataCB", void 0), de(this, "sendConfigsToFreshChatCB", void 0), de(this, "appConfig", void 0), de(this, "appConfigService", void 0), de(this, "impostorConfig", void 0), de(this, "impostor", void 0), de(this, "openWidgetOnLoad", void 0), de(this, "isWidgetBeingLoaded", void 0), de(this, "loadFreshChatCB", void 0), de(this, "unbindBrowserEventsCB", void 0), de(this, "rejectLoadingFreshchat", void 0), de(this, "activityEvents", void 0), de(this, "dontLoadWithImpostor", !0), this.payload = e, this.eagerLoad = null == e || null === (n = e.config) || void 0 === n ? void 0 : n.eagerLoad
                }
                var n, i, o;
                return n = t, i = [{
                    key: "init",
                    value: function() {
                        ...
                        return new Promise(function(t, n) {
                            var i, o;
                            se(this, e), this.loadFreshChatCB = t, this.rejectLoadingFreshchat = n, null !== (i = this.payload) && void 0 !== i && null !== (o = i.config) && void 0 !== o && o.eagerLoad ? this.processImpostor() : this.loadFreshChat()
                        }.bind(this))
                    }
                }, {
                    key: "onDemand",
                            ...
                            function(e, t) {
                                var n = this,
                                    i = new Promise(function(e, i) {
                                        var o = this;
                                        ae(this, n), setTimeout(function() {
                                            ae(this, o), i(new Error("Timeout triggered"))
                                        }.bind(this), t)
                                    }.bind(this));
                                return Promise.race([e, i])
                            }(this.appConfigService.fetch(), e.impostor.timeoutForFetchingConfigInMillis).then(function(e) {
                                var n, i;
                                se(this, t), this.appConfig = e, this.impostorConfig = this.getImpostorConfig(), null !== (n = this.impostorConfig) && void 0 !== n && n.hideMessenger ? this.rejectLoadingFreshchat() : (this.listenToWidgetAndBrowserEvents(), null !== (i = this.impostorConfig) && void 0 !== i && i.show && (this.impostor = new oe(this.impostorConfig).create()))
                            }.bind(this), function() {
                                se(this, t), this.appConfigService.cleanUp(), this.loadFreshChat({
                    ...
                    value: function() {
                        ...
                        this.activityEvents.forEach(function(t) {
                            se(this, e), document.removeEventListener(t, this.unbindBrowserEventsCB, !0)
                    ...
                    value: function() {
                        var e = this;
                        this.activityEvents.forEach(function(t) {
                            se(this, e), document.addEventListener(t, this.unbindBrowserEventsCB, !0)
                        }.bind(this))
                    }
                }, {
                    key: "onWidgetOpened",
        ...
        var fe = function() {
            ...
            var n = function(e) {
                    var n, i;
                    t.reset(), o.reset(), p.reset(), O(), R.unsubscribe(), w.init({
                        host: e.host.trim(),
                        token: e.token.trim(),
                        ...
                        cspNonce: e.cspNonce,
                        omniCookie: W.getCookie() || e.omniCookie,
                        eagerLoad: (null == e || null === (i = e.config) || void 0 === i ? void 0 : i.eagerLoad) || null,
                        jsFunctions: e.jsFunctions
                    }), t.openOnLoad(e.open), e.identifyByReferenceId && o.setIdentifyByReferenceId(!0), e.flowId && o.setFlowId(e.flowId), e.integrations && o.setIntegrations(e.integrations), e.campaignRuleIds && o.setcampaignRuleIds(e.campaignRuleIds), e.flowVersionId && o.setFlowVersionId(e.flowVersionId), e.previewMode && o.setPreviewMode(e.previewMode), o.setIsTemplateBot(e.isTemplateBot), e.externalId && (o.setExternalId(e.externalId), o.setRestoreId(e.restoreId)), e.tags && e.tags.length && t.setTags(e.tags), e.faqTags && t.setFaqTags(e.faqTags), e.botsMeta && p.setProperties(e.botsMeta), o.setProperties({
                        ...
                        locale: e.locale,
                        meta: e.meta
                    }), o.setConfig(e.config), e.onLoad && E.subscribe("widget:loaded", e.onLoad), w.add(), R.subscribe()
                },
                i = function() {
                    var e = document,
                        t = e.createElement("link"),
                        n = w.getHost();
                    t.href = n + "/widget/css/widget.css?t=" + (new Date).getTime(), t.rel = "stylesheet", e.getElementsByTagName("head")[0].appendChild(t)
                };
            return {
                init: function(t) {
                    ...
                    var o = function() {
                        ...
                        var a = -1 !== ["Chrome", "Firefox", "Safari", "Edge", "Trident", "WebView"].indexOf(m.getAgent.name),
                            s = -1 !== ["Station"].indexOf(m.getAgent.appName);
                    ...
                    window.Promise ? new ue(t).init(t).then(o, (function() {})) : o()
                },
                destroy: function() {
                    I.unload(), w.unload()
                },
                ...
                setTags: function(e) {
                    t.isLoaded() && (e && e.length ? t.setTags(e) : t.setTags([]), y.subscribe("set_tags", {
                        tags: t.getTags(),
                        force: !0
                    }))
                },
                setFaqTags: function(e) {
                    t.isLoaded() && (e ? t.setFaqTags(e) : t.setFaqTags({}), y.subscribe("set_faq_tags", {
                ...
                setExternalId: function(e, t) {
                    var n = {};
                    if (e) {
                        if ("string" == typeof e ? n.externalId = e : n = e, !(void 0 === window.Promise || t && "function" == typeof t)) return C("set_external_id", n);
                        _("set_external_id", n, t)
                    }
                },
                setConfig: function(t) {
                    var n = document.getElementById(e.frameDivId);
                    n && t && (void 0 !== t.fullscreen && (n.classList.remove(e.classes.fullscreenClass), !0 === t.fullscreen && n.classList.add(e.classes.fullscreenClass)), t.headerProperty && (void 0 !== t.headerProperty.direction && (n.classList.remove("fc_l2r"), "ltr" === t.headerProperty.direction && n.classList.add("fc_l2r")), void 0 !== t.headerProperty.hideChatButton && (n.classList.remove("fc_dn"), t.headerProperty.hideChatButton && n.classList.add("fc_dn")))), y.subscribe("set_custom_config", t)
                },
                conversation: {
                    setProperties: function(e) {
                        p.setProperties(e), y.subscribe("set_bots_properties", p.getProperties())
                    }
                },
                user: {
                    get: function(e) {
                        if (!(void 0 === window.Promise || e && "function" == typeof e)) return C("get_user");
                        _("get_user", e)
                    },
                    isExists: function(e) {
                        if (!(void 0 === window.Promise || e && "function" == typeof e)) return C("user_exists");
                        _("user_exists", e)
                    },
                    update: function(e, t) {
                        if (e.jwtAuthToken ? w.setJWTAuthToken(e.jwtAuthToken) : (e.firstName && o.setFirstName(e.firstName), e.lastName && o.setLastName(e.lastName), e.email && o.setEmail(e.email), e.phone && o.setPhone(e.phone), e.phoneCountry && o.setPhoneCountry(e.phoneCountry), e.meta && o.setUserMeta(e.meta)), !(void 0 === window.Promise || t && "function" == typeof t)) return C("update_user", e);
                        _("update_user", e, t)
                    },
                    setProperties: function(e, t) {
                        var n = {};
                        if (e.jwtAuthToken ? (w.setJWTAuthToken(e.jwtAuthToken), n = e) : (e.firstName && (n.firstName = e.firstName, delete e.firstName), e.lastName && (n.lastName = e.lastName, delete e.lastName), e.email && (n.email = e.email, delete e.email), e.phone && (n.phone = e.phone, delete e.phone), e.phoneCountryCode && (n.phoneCountry = e.phoneCountryCode, delete e.phoneCountryCode), e.locale && (n.locale = e.locale, delete e.locale), n.meta = e, o.setProperties(n)), !(void 0 === window.Promise || t && "function" == typeof t)) return C("set_user_properties", n);
                    ...
                    clear: function(e) {
                        if (!(void 0 === window.Promise || e && "function" == typeof e)) return C("reset_user");
                        _("reset_user", e)
                    },
                    create: function(e, t) {
                        if ("function" == typeof e && (t = e, e = null), !(void 0 === window.Promise || t && "function" == typeof t)) return C("create_user", e);
                        _("create_user", e, t)
                    },
                    clone: function(e, t) {
                        if ("function" == typeof e && (t = e, e = null), !(void 0 === window.Promise || t && "function" == typeof t)) return C("clone_user", e);
                        _("clone_user", e, t)
                    },
                    getUUID: function(e) {
                        if (!(void 0 === window.Promise || e && "function" == typeof e)) return C("get_user_uuid");
                        _("get_user_uuid", e)
                    },
                    generateUUID: function(e) {
                        if (!(void 0 === window.Promise || e && "function" == typeof e)) return C("generate_user_uuid");
                ...
                authenticate: function(e) {
                    ...
                    if (w.isJWTEnabled()) {
                        var n = function() {
                                le(this, t), w.setJWTAuthToken(e), w.postMessage({
                                    action: "authenticate_user",
                                    payload: e
                                })
                            }.bind(this),
                            i = function(i) {
                                le(this, t), i && 200 === i.status ? this.user.update({
                                    jwtAuthToken: e
                                }) : n()
                            }.bind(this);
        ...
        if (window.fcWidget || (window.fcWidget = fe), window.fcSettings)
            if ("complete" === document.readyState) {
                ...
                he && "function" == typeof he && he(), fe.init(window.fcSettings)
